...
int main(int argc, char **argv) {
	...
	//setShaders(prog_hdlr, "vex/vert-Lambert.glsl", "vex/frag-Lambert.glsl");//逐顶点光
	setShaders(prog_hdlr, "pix/vert.glsl", "pix/frag.glsl");//逐像素方向光
	//setShaders(prog_hdlr, "pix/vert-point.glsl", "pix/frag-point.glsl");//逐像素点光
	//setShaders(prog_hdlr, "pix/vert-spot.glsl", "pix/frag-spot.glsl");//逐像素聚光
